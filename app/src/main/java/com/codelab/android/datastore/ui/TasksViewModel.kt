...
class TasksViewModel(
    ...
    private val tasksUiModelFlow = combine(
        repository.tasks,
        userPreferencesFlow
    ) { tasks: List<Task>,userPreperences: TasksRepository.UserPreferences ->
        return@combine TasksUiModel(
            tasks = filterSortTasks(tasks, userPreperences.showCompleted, userPreperences.sortOrder),
            showCompleted = userPreperences.showCompleted,
            sortOrder = userPreperences.sortOrder
        )
    }
